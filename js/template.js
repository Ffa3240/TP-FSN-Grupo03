...
<ul class="navbar__menu">
    ...
    <li><a class="navbar__link" href="./pages/contacto.html">CONTACTO</a></li>
        ...
        <section>
            <nav class="navbar container">
                <ul class="navbar__item">
                    ...
                    <li class="navbar__item">
                        <a class="navbar__link" href="./pages/register.html">REGISTRARSE</a></li>
                    <li class="navbar__item">
                        <a class="navbar__link" href="./pages/login.html">LOGIN</a></li>
                    <li class="navbar__item">
                        <a class="navbar__link" href="./pages/contactos.html">CONTACTO</a></li>
                </ul>
